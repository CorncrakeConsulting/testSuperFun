import { When, setDefaultTimeout, World } from "@cucumber/cucumber";

setDefaultTimeout(60000);

When("the player clicks the spin button", async function (this: World) {
...
When(
  ...
  async function (this: World, times: number) {
...
When("the player clicks the autoplay button", async function (this: World) {
...
When("the player enables quick spin", async function (this: World) {
  await this.wheelGamePage.enableQuickSpin();
});

When("the player disables quick spin", async function (this: World) {
