...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertBalanceUpdated(this.initialBalance);
  }
);
...
Then(
  ...
  async function (this: CustomWorld, amount: number) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertBalanceDecreasedBy(this.initialBalance ?? 0, amount);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertWinAmountCalculatedCorrectly();
  }
);
...
Then(
  ...
  async function (this: CustomWorld, expectedBet: number) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertBetEquals(expectedBet);
  }
);
...
Then("autoplay should be enabled", async function (this: CustomWorld) {
  await new AssertionLogic(this.page, this.wheelGamePage).assertAutoplayEnabled();
});

Then("autoplay should be disabled", async function (this: CustomWorld) {
  await new AssertionLogic(this.page, this.wheelGamePage).assertAutoplayDisabled();
});

Then(
  "the autoplay display should show {string}",
  async function (this: CustomWorld, expectedText: string) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertAutoplayDisplayShows(expectedText);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertAnotherSpinStartsAutomatically();
  }
);
...
Then(
  ...
  async function (this: CustomWorld, expectedBalance: number) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertBalanceEquals(expectedBalance);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertBalanceIncreasedByWin(this.initialBalance ?? 0);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    this.initialBalance = await new AssertionLogic(this.page, this.wheelGamePage).assertBalanceDecreasedAfterFirstSpin(this.initialBalance ?? 0);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertBalanceChangedAfterAutoplaySecondSpin(this.initialBalance ?? 0);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertQuickSpinFasterThanNormal();
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertNormalSpinSpeed(this.spinStartTime);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertNormalSpinWithinMaxDuration(10000);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertQuickSpinWithinMaxDuration(4000);
  }
);

Then("all spins should be quick", async function (this: CustomWorld) {
  await new AssertionLogic(this.page, this.wheelGamePage).assertAllSpinsQuick(2, this.quickSpinBaseline);
});

Then(
  "the wheel should return to normal speed",
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertReturnToNormalSpeed(this.spinStartTime, this.normalSpinBaseline);
    this.spinStartTime = undefined;
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertAllSpinsFasterThanNormal(3);
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    new AssertionLogic(this.page, this.wheelGamePage).assertAllSliceWinningsMatchSprites(this.multiplierTestResults || [], this.attach.bind(this));
  }
);
...
Then(
  ...
  async function (this: CustomWorld) {
    await new AssertionLogic(this.page, this.wheelGamePage).assertSpriteToMultiplierMappings();
  }
);
